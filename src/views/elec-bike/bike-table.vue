  ...
  <div class="app-container">
    <div class="filter-container">
      ...
      <el-select v-model="listQuery.bikeType" placeholder="车辆状态" clearable class="filter-item" style="width: 130px">
        <el-option v-for="item in bikeTypeOptions" :key="item.key" :label="item.display_name+'('+item.key+')'" :value="item.key" />
      </el-select>
      <el-select v-model="listQuery.isMoving" placeholder="是否移动中" clearable class="filter-item" style="width: 130px">
        <el-option v-for="item in isMovingOptions" :key="item.key" :label="item.display_name+'('+item.key+')'" :value="item.key" />
      </el-select>
      <!--<el-select v-model="listQuery.importance" placeholder="Imp" clearable style="width: 90px" class="filter-item">-->
        <!--<el-option v-for="item in importanceOptions" :key="item" :label="item" :value="item" />-->
      <!--</el-select>-->
      <el-select v-model="listQuery.useType" placeholder="Type" clearable class="filter-item" style="width: 130px">
        <el-option v-for="item in useTypeOptions" :key="item.key" :label="item.display_name+'('+item.key+')'" :value="item.key" />
      </el-select>
...
<script>
  import { fetchList, fetchPv, createArticle, updateArticle } from '@/api/bike'
